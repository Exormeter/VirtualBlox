...
namespace UnityEngine.UI
{
    ...
    public class BlockToggleGroup : UIBehaviour
    {
        ...
        public delegate void ChangedEventHandler(BlockStructure structure);
        ...
        public new void Start()
        {
            ...
            {
                var toggle = transformToggle.gameObject.GetComponent<UnityEngine.UI.BlockToggle>();
                //var toggle = transformToggle.gameObject.GetComponents<Component>();
                toggle.onValueChanged.AddListener((isSelected, blockStructure) =>
                {
                    if (!isSelected)
                    {
                        return;
        ...
        protected virtual void DoOnChange(BlockStructure structure)
        {
