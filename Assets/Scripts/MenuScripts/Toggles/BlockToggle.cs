...
namespace Valve.VR.InteractionSystem
{
    ...
    public class BlockToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        /// <summary>
        ...
        /// </summary>
        public class ToggleEvent : UnityEvent<bool, CustomBlockStructure>
        { }
        ...
        [SerializeField]
        private BlockToggleGroup m_Group;

        /// <summary>
        /// Group the toggle belongs to.
        /// </summary>
        public BlockToggleGroup group
        {
            get { return m_Group; }
            set
            {
        ...
        public virtual void Rebuild(CanvasUpdate executing)
        {
            ...
            if (executing == CanvasUpdate.Prelayout)
                onValueChanged.Invoke(m_IsOn, new CustomBlockStructure(Rows, Columns, true));
#endif
        }
        ...
        private void SetToggleGroup(BlockToggleGroup newGroup, bool setMemberValue)
        {
