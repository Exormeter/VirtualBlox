...
namespace Valve.VR.InteractionSystem
{
    ...
    /// </summary>
    public class CustomBlockStructure : BlockStructure
    {
        /// <summary>
        ...
        public CustomBlockStructure(int row, int col, BLOCKSIZE size, Color color) : base(color, new CustomBlockGeneration())
        {
            Rows = row;
            Cols = col;
            matrix = new BlockPart[row, col];
            BlockSize = size;
            GenerationStrategie.SetCustomStructure(this);
        }

        public CustomBlockStructure(int row, int col, BLOCKSIZE size, Color color, bool[,] serializedMatrix) : base(color, new CustomBlockGeneration())
        {
            Rows = row;
            Cols = col;
        ...
        public CustomBlockStructure(int rows, int columns, bool fill = false) : base(Color.red, new CustomBlockGeneration())
        {
            Rows = rows;
            Cols = columns;
