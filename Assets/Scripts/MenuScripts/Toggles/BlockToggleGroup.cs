...
namespace UnityEngine.UI
{
    ...
    public class BlockToggleGroup : UIBehaviour
    {
        ...
        public delegate void ChangedEventHandler(CustomBlockStructure customBlockStructure);
        ...
        protected virtual void DoOnChange(CustomBlockStructure blockStructure)
        {
